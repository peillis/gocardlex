defmodule RedirectFlowTest do
  ...
  test "create_redirect_flow/1 creates a new Redirect Flow" do
    ...
    {:ok, %{"redirect_flows" => redirect_flow}} = Gocardlex.Client.create_redirect_flow(params)
  ...
  test "get_redirect_flow/1 returns a Redirect Flow" do
    ...
    {:ok, %{"redirect_flows" => retrieved_redirect_flow}} = Gocardlex.Client.get_redirect_flow(redirect_flow["id"])
